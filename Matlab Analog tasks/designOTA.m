...
OTA.M1.ro = % Complete the line to compute the ro of M1
...
OTA.M1.ID = % Complete the line to get the current of M1
...
OTA.M1.L = %Complete the line to get the minimum L that gives gm/gds >= OTA.M1.gm_gds
...
OTA.M3.ro = %Complete the line to get the ro of the CM load
...
OTA.M3.ID_W = %Complete the line to get the ID/W of M3
...
% get CMIN bias value
OTA.M1.VGS = %Complete the line to get the VGS of M1
OTA.M1.VG = %Complete the line to get the DC CM input of OTA