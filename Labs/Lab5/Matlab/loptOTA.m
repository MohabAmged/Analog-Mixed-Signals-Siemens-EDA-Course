...
load 180nch.mat;
load 180pch.mat;
UB = [2.00, 2.00, 2.00 , 20, 15 , 25, 1e-4];  % upper limits for inputs 
LB = [0.18, 0.18, 0.18, 15 , 10 , 10 ,1e-6];  % lower limits for inputs

%% Add line here for inital inputs (X0 = ??)
X0=[OTA.M1.L,OTA.M3.L,OTA.M5.L,OTA.M1.gm_ID,OTA.M3.gm_ID,OTA.M5.gm_ID,OTA.M5.ID];
